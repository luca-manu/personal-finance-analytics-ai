...
Se quiser deixar mais “senior”, você pode adicionar logo abaixo do título:

End-to-end data pipeline focused on automation, data quality, and decision support.
